...
<body>
			...
			<div class="frame-main-inner" id="content">
				...
				<div id="add-body">
					...
					<form:form commandName="productMetaForm"
						action="${contextPath}/productmeta/edit" method="put">
						<token:token></token:token>
						<table class="list-table1">
							<tr>
								<td align="right">属性名称<span style="color: red;">*</span>：</td>
								<td align="left"><form:input path="name" maxlength="20" />
									<label><form:errors path="name"></form:errors>
								</label></td>
							</tr>
							<tr>
								<td align="right">属性类型：</td>
								<td align="left"><form:select path="type"
										cssClass="selectStyle" items="${typeList}" id="type"
										multiple="" itemLabel="name" itemValue="id" /> <span
									id="enumadd"></span></td>
							</tr>
							<tr>
								<td align="right">属性分类：</td>
								<td align="left"><form:select path="category">
										<form:option value="1">图书</form:option>
										<form:option value="2">音像</form:option>
										<form:option value="3">百货</form:option>
									</form:select><label></label></td>
							</tr>
							<tr>
								<td align="right">属性长度<span style="color: red;">*</span>：</td>
								<td align="left"><form:input path="length" /> <label><form:errors
											path="length"></form:errors>
								</label></td>
							</tr>
							<tr>
								<td align="right">是否可为空：</td>
								<td align="left"><form:select path="allowNull"
							...
							<tr>
								...
								<td align="left"><form:select path="show"
										cssClass="selectStyle">
										<form:option value="1" label="是"></form:option>
										<form:option value="0" label="否"></form:option>
									</form:select></td>
							...
							<tr>
								...
								<td align="left"><form:input path="defaultValue"
										maxlength="200" /></td>
							</tr>
							<tr>
								<td align="right">状态：</td>
								<td align="left"><form:select path="available"
										cssClass="selectStyle">
							...
							<tr>
								<td align="center" colspan="2"><input type="submit"
									class="buttonstyle" value="提交" /> <input type="reset"
									class="buttonstyle" value="重置" /></td>
							</tr>
						</table>
						<form:hidden path="id" />
					</form:form>
	...
	<script type="text/javascript"
		src="${contextPath}/js/productmeta/productmeta.js"></script>
	<link type="text/css"
		href="${pageContext.request.contextPath}/css/productmeta/productMetaEnum.css"
		rel="stylesheet" />
	<script type="text/javascript"
