...
<body>
	<div class="frame" >
		...
		<div class="frame-main">
			...
			<div>
		 		 <form:form action="/user/reset" method="post" commandName="resetUserForm">
			        <input name="_method" type="hidden" value="post"/>
				    <table class="view" width="100%" border="0" cellspacing="0">
				      <tr>
				        <td class="txt_right" style="width: 255px;">账号：</td>
				        <td>
				            <form:input path="name" class="input_txt" value="${resetUserForm.name}"/>
				      ...
				      <tr>
				        ...
				        <td>
				            <form:input path="password" class="input_txt" value="${resetUserForm.password}"/>
