		...
		<div class="frame-main">
			<div id="content">
			   ...
			   <div id="delaydiv" style="display: none">
			       ...
			       延期到<input type="text" id="date" bind="datepicker">
			       <button id="delay">确定</button>
			   </div>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/presentcard/delay_presentcard.js"></script>	
</body>
</html>