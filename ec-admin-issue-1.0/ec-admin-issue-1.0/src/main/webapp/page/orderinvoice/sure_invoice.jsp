	...
	<div class="frame">
		...
		<div class="frame-main">
			...
			<div class="frame-main-inner" id="content">
				<center>
					<div class="step">
				<img src="${contextPath}/css/images/invoice_bk_step_2.jpg">
			</div>
					<div id="ninvoice-body">
						<table class="list-table1">
							<tr>
								<td align="right">订单号</td>
								<td colspan="3"><label class="iinfo-lable" id="orderId">${orderInvoiceCreateForm.orderId}</label>
								</td>
							</tr>
							<tr>
					...
					<div id="invoice-body">
						<form:form commandName="orderInvoiceCreateForm" name="invoiceForm"
							action="${contextPath}/orderinvoice/save" method="post">
							...
							<table class="list-table1">
								...
								<tr>
									...
									<td><label class="iinfo-lable"> <form:input
												path="titleType" /> </label>
									</td>
									<td align="right">发票抬头</td>
									<td><label class="iinfo-lable"><form:input
												path="title"></form:input> </label>
									</td>
								</tr>
								<tr>
									<td align="right">发票金额</td>
								...
								<tr>
									...
									<td colspan="3"><label class="iinfo-lable"> <!-- 国家 -->
											...
											<!-- 区县 --> <form:input path="district" /> 
											<!-- 乡镇 --><form:input path="town" /></label></td>
								</tr>
								<tr>
									<td align="right">详细地址</td>
									<td colspan="3"><label class="iinfo-lable"> <form:input
												size="83" path="address" /> </label></td>
								</tr>
							</table>
						</form:form>
