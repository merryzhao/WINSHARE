		...
		<div class="frame-main">
			...
			<div class="frame-main-inner" id="content">
				...
				<div>
				    <!-- 条件查询部分 -->
				    <div>
				    <form action="${contextPath }/presentcardorder/toactiveofdata" method="post">
						...
						<table class="list-table">
						  	...
						  	<tbody>
						  		<c:forEach var="presentCard" items="${presentCards}">
									<tr id="tr_list_${presentCard.id}" class="tr_list">
										<td><input type="checkbox" id="checkbox_${presentCard.id}"
					...
					<br> <br>
					<div>
						<input type="button" value="激活" id="activate" class="ui-button" />
					</div>
				</div>
				</c:if>
				</div>
