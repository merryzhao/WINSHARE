	...
	<div class="frame">
		...
		<div class="frame-main">
			...
			<div class="frame-main-inner" id="content">
				...
				<div align="center">
					<h4><c:if test="${empty message }">套装书创建成功!-><a href="http://console.winxuan.com/product/${complexId}/editcomplex">${complexId}</a> 
						<br /> <a href="/product/complex">新建套装书</a>
					</c:if>
					<c:if test="${not empty message }"><span style="color: red;">套装书创建失败</span><input type="button" onclick="window.history.go(-1)" value="返回修改"/></c:if></h4>
				</div>
			</div>
		</div>
		</div>
