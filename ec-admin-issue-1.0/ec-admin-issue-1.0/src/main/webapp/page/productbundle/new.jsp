		...
		<div class="frame-main">
			...
			<div style="color: red;">${msg}</div>
				...
				<div>
					...
					<textarea id="masterValue"></textarea>
					<a href='javascript:;' bind="addMaster">添加商品</a><span id="msg" style="color: red;"></span></div>
					<hr>
					<div>
				...
				<div id="btnpanel">
					...
					<form id="bundleform" method="post" action="/bundle/new"></form>
				</div>
				</div>
				</div>
				</div>
