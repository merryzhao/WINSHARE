	...
	<div class="frame">
		...
		<div class="frame-main">
			...
			<div class="frame-main-inner" id="content">
				...
				<form target="myiframe" action="/promotion/presentfororder"
					...
					<div id="orderPresentEdit">
						...
						<p>
							...
							<span>
								活动有效期:
								<input type="text" id="promotionStartDate" readonly="readonly" name="promotionStartDate"
								value="<fmt:formatDate pattern="yyyy-MM-dd" value="${promotion.startDate }" type="date"/>">时间<input
								value="<fmt:formatDate pattern="HH:mm" value="${promotion.startDate }" type="time"/>"
								...
								value="<fmt:formatDate pattern="yyyy-MM-dd" value="${promotion.endDate }" type="date"/>">时间<input
								value="<fmt:formatDate pattern="HH:mm"  value="${promotion.endDate }" type="time"/>"
					...
					<input type="hidden" value="${promotion.id}" id="pid"
						name="promotionId"> <input type="hidden" value="update"
						name="optionType">
					<div id="datasbm" style="display: none;">
						<input type="text" id="promotionData1" name="promotionData1"
							value="" />
					</div>
				</form>
				...
				<div id="tidu" style="padding-left: 66; display: none;">
					<p>
						订单满<input type="text" size="10" name="sendprice">元送 <a
							href="javascript:void(0);" id="addpresentitems1"
