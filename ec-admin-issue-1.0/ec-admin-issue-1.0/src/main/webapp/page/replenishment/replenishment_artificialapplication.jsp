		...
		<div class="frame-main">
			...
			<div class="frame-main-inner" id="content">
				...
				<div>
					<div>
						...
						<ul>
							...
							<li>2. 样例模板<a
								href="http://console.winxuan.com/excel/replenishment/artificialapplication.xls">下载</a></li>
							<li></li>
							<li></li>
						</ul>
					</div>
					<div id="uploadPanel">
						<form action="/replenishment/artificialApplicationExcelImport" method="post"
				...
				<div id="queryForm">
					...
					<form action="/replenishment/artificialApplicationList" method="post"
							...
							<c:forEach var="item" items="${items}">
								<tr id="tr_list_${item.id}" class="tr_list">
									...
									<c:if test="${item.availableQuantity<0}">
										<td> 
										<input type="hidden", value="${item.availableQuantity}"></td>
									</c:if>
									<c:if test="${item.availableQuantity>=0}">
