...
<title>【文轩网】订单${order.id}款项已收到，请留意我们的发货通知</title>
</head>
...
&nbsp;&nbsp;&nbsp;&nbsp;感谢您在文轩网购物，您的订单${order.id}<font style=" font-weight:bold; color:#FF0000; font-size:12px; color:#656464; font-family:'宋体';">款项已经收到</font>，我们会尽快处理订单，请您放心。<br />
<div style=" margin:0 auto; padding-top:5px; width:532px; line-height:18px; font-size:12px; color:#656464; font-family:'宋体';">有关订单信息及发货情况，您可以随时进入“<a href="http://www.winxuan.com/customer/order/${order.id}" target="_blank"><font style="color:#2A5B90; text-decoration:underline;">订单详情</font></a>”查看。 </div>
</div> 
    <div id="02form" style="margin:0 auto; width:570px; padding-top:22px; line-height:22px;font-size:12px; color:#656464; font-family:'宋体';"><strong>订单信息： </strong>
   ...
   <div id="04help" style="margin:0 auto; width:570px; padding-top:22px; padding-bottom:30px;font-size:12px; color:#656464; font-family:'宋体';"><strong>常见问题及相关帮助：</strong>
      	<div style=" margin:0 auto; width:570px; line-height:18px; padding-top:5px;">
	  	...
	  	<div style="margin:0 auto; width:570px; line-height:18px; padding-top:10px;font-size:12px; color:#656464; font-family:'宋体';">如果您需要查看或修改订单，请进入<a href="http://www.winxuan.com/customer/order/${order.id}" target="_blank" style=" text-decoration:none;"><font style="color:#2A5B90; text-decoration:none;">我的订单</font></a><br />
  ...
  <div style="margin:5px auto; width:650px; background-color:#CD0B27; ">
    <div style="margin:0px auto; padding:12px 0 12px 0; width:620px; line-height:17px; color:#ED7082;font-size:12px; color:#656464; font-family:'宋体';">·您之所以收到这封邮件，是因为您曾经注册成为文轩网用户<br />
