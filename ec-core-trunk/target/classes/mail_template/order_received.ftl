...
<title>【文轩网】感谢您的购物！请确认您的订单${order.id}商品已收到</title>
</head>
...
<div id="01txt" style="margin:0 auto; width:570px; padding-top:22px; line-height:22px;font-family:'宋体';font-size: 12px;"><strong>亲爱的${order.customer.displayName}：</strong><br />
  &nbsp;&nbsp;&nbsp;&nbsp;感谢您在文轩网购物，您的订单88498612<font style=" font-weight:bold; color:#FF0000; font-family:'宋体';font-size: 12px;">已经收到</font>。<br />
  <div style=" margin:0 auto; padding-top:5px; width:532px; line-height:18px;font-family:'宋体';font-size: 12px; ">1、您还可以订单确认时，对我们的服务进行评价，有积分哦：<a href="http://www.winxuan.com/order/${order.id}" target="_blank"><font style=" font-size:12px; font-weight:bold; color:#C79000; text-decoration:underline; ">确认订单</font></a>；<br />
2、如果您对收到的商品不满意，可以进入“我的文轩--<a href="http://www.winxuan.com/customer/returnorder" target="_blank"><font style="color:#2A5B90; text-decoration:underline;">申请退换货</font></a>”；<br />
3、如果您还没有收到商品，请<a href="#" target="_blank"><font style="color:#2A5B90; text-decoration:underline;">联系我们</font></a>；</div>
</div>
    <div id="02form" style="margin:0 auto; width:570px; padding-top:22px; line-height:22px;font-family:'宋体';font-size: 12px;"><strong>订单信息： </strong>
