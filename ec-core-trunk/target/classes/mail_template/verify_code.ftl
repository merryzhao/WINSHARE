...
<div id="01txt" style="margin:0 auto; width:570px; padding-top:22px; line-height:22px;"><strong>亲爱的 ${customer.displayName}：</strong><br />
  &nbsp;&nbsp;&nbsp;本次验证码：${verifyCode}
  
</div>
<div id="-02blank" style="margin:0 auto; width:570px; height:150px;"></div>  
</div>
