...
<html>
	<head>
		...
		<title>文轩网_加入文轩</title>
		<jsp:include page="/page/snippets/v2/meta.jsp"><jsp:param value="company" name="type"/></jsp:include>
	</head>
	<body>
	<div class="wrap">
		...
		<jsp:include page="/page/snippets/v2/navigation.jsp">
			...
			<div class="layout">
				<div class="your_path cl">你现在的位置： <span><a class="link4" title="文轩网" href="http://www.winxuan.com">文轩网</a> > 公司信息 > 加入文轩</span></div>
				    <div class="left_box">
				        <div class="about_us">
				            <h2>公司信息</h2>
				        <ul class="about_menu">
				                ...
				                <li class="cur_info"><a href="http://hr.winxuan.com">加入文轩</a>
				                	<dl class="join"><dt><a href="http://www.winxuan.com/company/society_join.html">社会招聘</a></dt><dt class="school"><a href="http://www.winxuan.com/company/school_join.html">校园招聘</a></dt></dl>				                					                	
				                </li>
				    ...
				    <div class="right_box margin10">
				      <h1 class="aboutus_tit">加入文轩</h1>
				      <div class="company_detail"> 
				      		<c:import url="/fragment/70002" />
				      		<c:import url="/fragment/70016" />
				      		<c:import url="/fragment/70003" />
				      		<c:import url="/fragment/70004" />
				      		<c:import url="/fragment/70005" />
				      	</div>
				      </div>
				      <div class="hei10"> </div>
				      </div>
