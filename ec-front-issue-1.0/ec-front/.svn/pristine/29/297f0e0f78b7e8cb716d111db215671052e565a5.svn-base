	...
	<div class="wrap">
		...
		<jsp:include page="/page/snippets/v2/navigation.jsp">
			...
			<jsp:include page="help_menu.jsp">
			  	<jsp:param value="help_2_1" name="label"/>
			  </jsp:include>
			  <div class="right_box">
    <div id="help_r">
      <h3>购物流程(电子书商品)</h3>
      <dl>
      	<h4><img src="images/libg.png" class="limg" />  购物流程图</h4>
        <dt><img src="images/ebuy-00.png" width="750" height="320"></dt>
      </dl>
      <dl>
