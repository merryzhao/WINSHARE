...
<div class="layout">
  ...
  <div class="right_box">
    ...
    <li class="step_statu"><span>3、填写换货原因</span></li>
    <li class="step_statu"><span>4、确认换货信息</span></li>
    <li class="last_step"><span>5、成功提交</span></li>
    </ul>
    <p class="return_box txt_center f16 fb">您正在提交订单 <b class="red fb">${orderId}</b> 的商品换货申请</p>
    <h3 class="app_title">换货商品详情</h3>
    <div class="hei10"></div>
    ...
    <table width="100%" class="favorite_goods record" cellspacing="0" cellpadding="0">
      <thead>
        <tr>
          ...
          <th width="13%"><b class="black">换货数量</b></th>
          <th width="42%"><b class="black">换货原因</b></th>
        </tr>
      </thead>
      <tbody>
...
<%--     <h3 class="app_title">退款方式</h3>
    ...
    <p class="border_style margin10"> <b class="fb">退换提示：</b><br/>
      1．因库存变化较快，在处理换货时可能会发生商品缺货，如遇缺货，我们将作换货处理<br/>
