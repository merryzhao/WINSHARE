...
<div class="layout">
  ...
  <div class="right_box">
    ...
    <p class="return_box txt_center f16 fb">您正在提交订单 <b class="red fb">${order.id }</b> 的商品退货申请</p>
    ...
    <table width="100%" class="favorite_goods record margin10" cellspacing="0" cellpadding="0">
      <thead>
        <tr>
          ...
          <th width="15%"><b class="black">退货数量</b></th>
          <th width="15%"><b class="black">申请退货</b></th>
        </tr>
      </thead>
      <tbody>
     ...
     <form:form action="/customer/returnorder/step3" name="selectReturnItemForm" commandName="returnOrderForms">
