...
<div class="special_offer"  content="special"fragment="412" style="display:none;">
		...
		<c:forEach items="${contentList}" var="content" varStatus="status"
			...
			<li>
				<p class="book_pic">
					...
					　<a　title="<c:out value="${content.product.name }"/>"　target="_blank"  href="${content.url }" class="link4">
