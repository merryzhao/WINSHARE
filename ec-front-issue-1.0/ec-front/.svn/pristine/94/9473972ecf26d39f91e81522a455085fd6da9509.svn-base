...
<div class="wrap">
   ...
   <div class="your_path cl">
    你现在的位置： 
    <span><a class="link4" title="文轩网" href="http://www.winxuan.com">文轩网</a> &gt; <a class="link4" title="音像" href="http://www.winxuan.com/media/">音像</a> &gt; 全部分类</span>
   </div> 
   <div class="all_cate"> 
    <ul class="category fix"> 
     <a href="catalog_book.html">
     <li>图书</li> 
     </a>
     <a href="catalog_media.html">
     <li class="cur_ca">音像</li> 
     </a>
     <a href="catalog_mall.html">
     <li>百货</li> 
     </a>
     <a href="catalog_ebook.html"><li>电子书</li></a>
    </ul> 
   	<c:import url="/category/tree/7786?jspfile=catelog_tree"> </c:import>
   </div> 
  </div> 
