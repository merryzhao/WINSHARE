...
<div class="layout">
  ...
  <div class="right_box">
    ...
    <li class="last_step step_statu"><span>5、成功提交</span></li>
    </ul>
    <p class="border_style changed_suc margin10"><span class="greenhook">&nbsp;</span><b>退货申请提交成功</b><br>
   	 我们的客服会随后与您联系...<br><br>
    <a class="link2" href="/customer/returnorder">关闭页面</a></p>
  </div>
  <div class="hei10"></div>
</div>
