...
<div class="layout">
  ...
  <div class="right_box">
    <h3 class="myfav_tit margin10">申请退款</h3>
    <p class="border_style changed_suc margin10"><span class="greenhook">&nbsp;</span><b>退款申请提交成功</b><br>您可以继续了解详细的<a class="link2" href="/customer/advanceaccount/refundlist">退款详情</a><br><br><a class="link2" href="/customer/advanceaccount">返回</a></p>
  </div>
  <div class="hei10"></div>
</div>
