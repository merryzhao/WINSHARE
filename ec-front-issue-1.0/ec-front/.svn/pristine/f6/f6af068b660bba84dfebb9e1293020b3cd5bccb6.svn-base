	...
	var $=require("jQuery"),
		...
		notify={
			template:{
				...
				"461004":"<div class='success'>操作成功!</div><ol><li>该商品降价后，我们会第一时间邮件通知您！</li><li>您可以进入“我的文轩-><a href='"+config.portalServer+"/customer/notify/priceReduce?reduced=true' target='arrivalNotify'>降价通知</a>”查看是否降价；</li></ol>"
			},
