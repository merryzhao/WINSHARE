...
<html>
	...
	<div class="wrap">
		...
		<jsp:include page="/page/snippets/v2/navigation.jsp">
			...
			<div class="layout">
				<div class="your_path cl">你现在的位置： <span><a class="link4" title="文轩网" href="http://www.winxuan.com">文轩网</a> > 公司信息  > 合作伙伴</span></div>
				    <div class="left_box">
				        <div class="about_us">
				            <h2>公司信息</h2>
				        <ul class="about_menu">
				                ...
				                <li class="cur_info"><a href="http://www.winxuan.com/company/partner.html">合作伙伴</a></li>
				                <li><a href="http://www.winxuan.com/company/job.html">加入文轩</a></li>
				    ...
				    <c:import url="/fragment/903"></c:import>
				    <div class="hei10"></div>
				</div>
