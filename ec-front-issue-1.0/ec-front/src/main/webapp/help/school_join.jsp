...
<html>
	...
	<div class="wrap">
		...
		<jsp:include page="/page/snippets/v2/navigation.jsp">
			...
			<div class="layout">
				<div class="your_path cl">你现在的位置： <span><a class="link4" title="文轩网" href="http://www.winxuan.com">文轩网</a> > 公司信息 > 加入文轩 > 校园招聘</span></div>
				    <div class="left_box">
				        <div class="about_us">
				            <h2>公司信息</h2>
				        <ul class="about_menu">
				                ...
				                <li class="cur_info"><a href="http://www.winxuan.com/company/job.html">加入文轩</a>
				                	<dl class="join" id="resume_model"><dt><a href="http://www.winxuan.com/company/society_join.html">社会招聘</a></dt><dt class="school cur_red"><a href="http://www.winxuan.com/company/school_join.html">校园招聘</a></dt></dl>				                					                	
				                </li>
