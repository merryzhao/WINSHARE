...
<div class="layout">
  <div class="your_path cl">你现在的位置： <span><a href="http://www.winxuan.com/" class="link3">文轩网</a> &gt;  我的数字馆  &gt;  书籍券兑换</span></div>
<jsp:include page="/page/left_menu.jsp">
	<jsp:param name="id" value="5_3" />
</jsp:include>
  <div class="right_box">
    <iframe frameborder="0" width="100%" id="bookFrame" height="600" src="http://www.9yue.com/winxuan/exchange.html?userId=${userId}&token=${token}"></iframe>
