...
<div class="layout">
 ...
 <div class="right_box">
    ...
    <b class="f14 black fb">订单号：</b>
    	...
    	<input class="red_but" name="" bind="applyReturnSubmit" type="button" value="申请换货"></p>
    </form:form>
    <p class="border_style margin10"> 
    <b class="fb red">换货须知：</b><br/>
文轩网承诺自顾客收到商品之日起(以发票日期为准)7日内，如符合以下条件，我们将提供全款换货的服务：<br/>
1．商品及商品的外包装没有损坏(包括包裹填充物及外包装箱或外包装袋)，并保持文轩网出售时的原质原样；<br/>
2．注明换货原因，如果商品存在质量问题，请务必说明；<br/>
3．准备好原始发票及文轩网发货清单；<br/>
4．如果成套商品中有部分商品存在质量问题，在办理换货时，必须提供成套商品。<br/>
5．参加多买多折扣促销的商品，换货时必须全部退回。加申请过换货，则不再允许换货。<br/><br/>
<b class="fb">以下情况不予办理换货：</b><br/>
▪ 任何非由文轩网出售的商品；<br/>
▪ 任何已使用过的商品，但有质量问题除外；<br/>
▪ 任何因非正常使用及保管导致出现质量问题的商品。<br/>
▪ 赠品未返还的商品(商品换货时，如含赠品，赠品需同时退回)。<br/><br/>
