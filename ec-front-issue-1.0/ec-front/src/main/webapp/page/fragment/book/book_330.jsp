...
<ul class="hotpro_list" fragment="330" >
...
<c:forEach items="${contentList}" var="content" varStatus="status">
	<li>
		...
		</p> <strong><a title="<c:out value="${content.name }"/>"   target="_blank"  href="${content.url }"><winxuan-string:substr length="16" content="${content.product.name}"/></a>
