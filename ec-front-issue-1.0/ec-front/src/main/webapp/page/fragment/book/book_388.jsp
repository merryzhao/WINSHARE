...
<%--已使用book_382片段 --%>
<div class="new_works" fragment="388">
<jsp:include page="../null.jsp"/>
<c:forEach items="${contentList}" var="content" varStatus="status">
	<a class="book_img" title="<c:out value="${content.product.name }"/>"   target="_blank"  href="${content.url }">
	...
	<div class="margin10">
		...
		（<a class="link4" href="javascript:;">${content.productTransient.rankCount }人评价</a>）
	</div>
	<p>
