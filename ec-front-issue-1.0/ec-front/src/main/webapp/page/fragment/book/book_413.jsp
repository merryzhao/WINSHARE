...
<div class="special_offer"  content="special" fragment="413" style="display:none;">
	...
	<ul class="gallery_mode">
		<c:forEach items="${contentList}" var="content" varStatus="status"
			...
			<li>
				...
				</p> <strong><a　title="<c:out value="${content.product.name }"/>"　target="_blank"  href="${content.url }" class="link4">${content.product.name }</a> </strong>
				<p class="s_price">
