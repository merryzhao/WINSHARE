...
<div class="special_offer"  content="special" fragment="416" style="display:none;">
	...
	<dl class="list_mode">
		<c:forEach items="${contentList}" var="content" varStatus="status">
			<c:if test="${status.index==3 }">
				<dt>
					<a class="specialList" title="<c:out value="${content.product.name }"/>"　target="_blank"  href="${content.url }">
						<img src="${content.imageUrl }"　alt="${content.product.name }"> </a>
					<p>
