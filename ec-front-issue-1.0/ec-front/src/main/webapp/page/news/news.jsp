...
<div class="layout">
    <div class="your_path cl">你现在的位置： <span><a href="http://www.winxuan.com/" class="link3">文轩网</a> &gt;   新闻公告</span></div>
    <div class="news_left">
        <h1>新闻公告</h1>
        <dl class="news_list">
  ...
  <%--   <div class="news_right">
        ...
        <a class="pro_ads" href="javascript:;"><img src="${serverPrefix}/images/ads/ads04.png"></a> <a class="pro_ads" href="javascript:;"><img src="${serverPrefix}/images/ads/ads04.png" alt=""></a> <a class="pro_ads" href="#"><img src="${serverPrefix}/images/ads/ads04.png" alt=""></a> 
        </div> --%>
    <div class="hei10"></div>
</div>
