...
<title>Excuting Task---Winxuan.Com</title>
<%@include file="../snippets/meta.jsp"%>
</head>
<body>
<div class="ui-grid ui-widget ui-widget-content ui-corner-all"> 
<div class="ui-grid-header ui-widget-header ui-corner-top">运行中任务 [<fmt:formatDate value="${nowTime}" pattern="yyyy-MM-dd HH:mm:ss"/>]
				<input type="button" id="refreshTriggerButton" onclick="refreshRun()"  value="刷新">
</div> 
